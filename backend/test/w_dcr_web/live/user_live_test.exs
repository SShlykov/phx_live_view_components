defmodule WDcrWeb.UserLiveTest do
  ...
  @create_attrs %{email: "some email", first_name: "some first_name", is_verified: true, last_name: "some last_name", password_hash: "some password_hash"}
  @update_attrs %{email: "some updated email", first_name: "some updated first_name", is_verified: false, last_name: "some updated last_name", password_hash: "some updated password_hash"}
  @invalid_attrs %{email: nil, first_name: nil, is_verified: nil, last_name: nil, password_hash: nil}
